...
"[project]/node_modules/mermaid/dist/flowchart-elk-definition-4a651766.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mermaid/dist/mermaid-b5860b54.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$elkjs$2f$lib$2f$elk$2e$bundled$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/elkjs/lib/elk.bundled.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ts$2d$dedent$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/ts-dedent/esm/index.js [app-ssr] (ecmascript)");
...
const elk = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$elkjs$2f$lib$2f$elk$2e$bundled$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]();
let portPos = {};
const conf = {};
let nodeDb = {};
const addVertices = async function(vert, svgId, root, doc, diagObj, parentLookupDb, graph) {
    ...
    await Promise.all(keys.map(async function(id) {
        ...
        const styles2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(vertex.styles);
        ...
        const node = {
            ...
            type: vertex.type,
            props: vertex.props,
            padding: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"])().flowchart.padding
        };
        let boundingBox;
        let nodeEl;
        if (node.type !== "group") {
            nodeEl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(nodes, node, vertex.dir);
            boundingBox = nodeEl.node().getBBox();
        } else {
            doc.createElementNS("http://www.w3.org/2000/svg", "text");
            const { shapeSvg, bbox } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(nodes, node, void 0, true);
            labelData.width = bbox.width;
            labelData.wrappingWidth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"])().flowchart.wrappingWidth;
...
const getNextPort = (node, edgeDirection, graphDirection)=>{
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("getNextPort", {
        node,
        edgeDirection,
        graphDirection
    });
...
const addEdges = function(edges, diagObj, graph, svg) {
    ...
    edges.forEach(function(edge) {
        ...
        if (edge.style !== void 0) {
            const styles2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(edge.style);
            style = styles2.style;
            labelStyle = styles2.labelStyle;
        }
        ...
        const labelEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"])(labelsEl, edgeData);
        const { source, target, sourceId, targetId } = getEdgeStartEndPoint(edge, dir);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("abc78 source and target", source, target);
        graph.edges.push({
...
const addMarkersToEdge = function(svgPath, edgeData, diagramType, arrowMarkerAbsolute, id) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["m"])(svgPath, edgeData, url, id, diagramType);
};
...
const insertEdge = function(edgesEl, edge, edgeData, diagObj, parentLookupDb, id) {
    ...
    const { x, y } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(edge.edgeData);
    const curve = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$shape$2f$src$2f$line$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__line$3e$__["line"])().x(x).y(y).curve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$shape$2f$src$2f$curve$2f$linear$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__curveLinear$3e$__["curveLinear"]);
    const edgePath = edgesEl.insert("path").attr("d", curve(points)).attr("class", "path " + edgeData.classes).attr("fill", "none");
    const edgeG = edgesEl.insert("g").attr("class", "edgeLabel");
    const edgeWithLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"])(edgeG.node().appendChild(edge.labelEl));
...
const draw = async function(text, id, _version, diagObj) {
    ...
    const renderEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2d$selection$2f$src$2f$select$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__select$3e$__["select"])("body").append("div").attr("style", "height:400px").attr("id", "cy");
    let graph = {
        id: "root",
        layoutOptions: {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("Drawing flowchart using v3 renderer", elk);
    let dir = diagObj.db.getDirection();
    switch(dir){
        case "BT":
    ...
    const { securityLevel, flowchart: conf2 } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"])();
    let sandboxElement;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$edges$2d$e0da2a9e$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(svg, markers, diagObj.type, id);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("after layout", JSON.stringify(graph, null, 2));
    const g = await elk.layout(graph);
    drawNodes(0, 0, g.children, svg, subGraphsEl, diagObj, 0);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("after layout", g);
    (_a = g.edges) == null ? void 0 : _a.map((edge)=>{
        insertEdge(edgesEl, edge, edge.edgeData, diagObj, parentLookupDb, id);
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["o"])({}, svg, conf2.diagramPadding, conf2.useMaxWidth);
    renderEl.remove();
};
    ...
    nodeArray.forEach(function(node) {
        if (node) {
            ...
            if (node.type === "group") {
                ...
                const labelCentering = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["F"])().flowchart.htmlLabels ? node.labelData.width / 2 : 0;
                label.attr("transform", `translate(${node.labels[0].x + relX + node.x + labelCentering}, ${node.labels[0].y + relY + node.y + 3})`);
                label.node().appendChild(node.labelData.labelNode);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("Id (UGH)= ", node.type, node.labels);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].info("Id (UGH)= ", node.id);
...
const diagram = {
    db: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$flowDb$2d$956e92f1$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"],
    renderer,
...
//# sourceMappingURL=node_modules_mermaid_dist_eb60833f._.js.map