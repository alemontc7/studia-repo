...
"[project]/node_modules/mermaid/dist/timeline-definition-85554ec2.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const tasks = [];
const rawTasks = [];
const getCommonDb = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["L"];
...
const draw = function(text, id, version, diagObj) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("timeline", diagObj.db);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("task", tasks2);
    svgDraw.initGraphics(svg);
    const sections2 = diagObj.db.getSections();
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("sections", sections2);
    ...
    sections2.forEach(function(section) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("sectionHeight before draw", sectionHeight);
        maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
    });
    let maxEventCount = 0;
    let maxEventLineLength = 0;
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("tasks.length", tasks2.length);
    for (const [i, task] of tasks2.entries()){
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("taskHeight before draw", taskHeight);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("maxSectionHeight before draw", maxSectionHeight);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("maxTaskHeight before draw", maxTaskHeight);
    if (sections2 && sections2.length > 0) {
        sections2.forEach((section)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("sectionNode", sectionNode);
            const sectionNodeWrapper = svg.append("g");
            const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("sectionNode output", node);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("bounds", box);
    if (title) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["o"])(void 0, svg, ((_a = conf.timeline) == null ? void 0 : _a.padding) ?? 50, ((_b = conf.timeline) == null ? void 0 : _b.useMaxWidth) ?? false);
};
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
    ...
    for (const task of tasks2){
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("taskNode", taskNode);
        const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
        const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf);
        const taskHeight = node.height;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("taskHeight after draw", taskHeight);
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf) {
    ...
    for (const event of events){
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2d$b5860b54$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"].debug("eventNode", eventNode);
...
//# sourceMappingURL=node_modules_e4184bf9._.js.map